...
network = fully_connected(network, 768, activation='relu')
network = dropout(network, 0.5)
...
model.fit(X, Y, n_epoch=15, validation_set=0.1, shuffle=False,
          show_metric=True, batch_size=8, snapshot_step=200,
          snapshot_epoch=False, run_id='custum_carmodel_v2')
model.save('custum_carmodel_v2.tfmodel')
