...
data_dir = "/home/thongpb/TensorFlow_Work/data_car/CAM1_1_7/test"
dir_test_folder = '/home/thongpb/TensorFlow_Work/data_car/CAM1_1_7/test'

model_path = "/home/thongpb/TensorFlow_Work/TF-Learn"
...
print(Y[2])
print(Y[3])
# X_test, Y_test = image_preloader(dir_test_folder, image_shape=(224, 224), mode='folder',
#                        categorical_labels=True, normalize=True,
#                        files_extension=['.jpg', '.png'], filter_channel=True)
num_classes = 8 # num of your dataset
...
#           show_metric=True, batch_size=1, snapshot_epoch=False,
